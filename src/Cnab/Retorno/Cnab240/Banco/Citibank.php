...
class Citibank extends AbstractRetorno implements RetornoCnab240
{
    /**
     * Código do banco
     *
     ...
     */
    private $ocorrencias = [
        '01' => 'Transação aceita título impresso/enviado por e_mail',
        ...
        '21' => 'Confirmação de pedido de exclusão de negativação na Serasa',
        '22' => 'Título enviado para negativação na Serasa',
    ...
    private $rejeicoes = [
        ...
        'UA' => 'Indicador de apresentação vlr mínimo inválido',
    ];
